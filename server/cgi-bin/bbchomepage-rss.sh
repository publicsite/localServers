...
outhtml="${outhtml}<h2 style=\"color:white\">Most Read</h2>$(printTag "$thehtml" "div" "mostRead" "" | sed 's#a href="#a style="text-decoration:none;color:green;" href="https://www.bbc.co.uk#g')"
...
outhtml="${outhtml}<hr><h2 style=\"color:white\">Most Watched</h2>$(printTag "$thehtml" "div" "mostWatched" "" | sed 's#a href="#a style="text-decoration:none;color:green;" href="https://www.bbc.co.uk#g')"
